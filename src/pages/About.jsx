...
const About = () => {
    return (
        <main className='about-main'>
            ...
            <section className="about-section">
                <h2>What we do?</h2>
                <p>Well, to start with - Everything to make you feel Special! A stylist to discuss your fashion needs, a delivery guarantee, and no question asked return/exchange policy and a promise to ensure quality in all our products. We believe in outrageous fashion trends and offer you the same, but with a hint of class. Our famous fashion advice for all is: <span> Don't just be Stylish, be Smart, buy Smart on JUTACHAPPAL.com! </span> </p>
            </section>
            <section className="about-section">
                <h2>How to get it going?</h2>
                <p>Welcome to the world of JUTACHAPPAL - a smart, quick and easy way to get yourself access to the latest fasionista. All you need to do is access our online storefront and fill out a brief survey to help us know your personal style needs and preferences. Once you tell us what you like, our team of stylists will take you to an exciting journey, showing you the variety we boast of and will help you choose the best. And believe us – online shopping at JUTACHAPPAL is a lot of fun, not even a bit of it will disappoint you.</p>
            </section>
            <section className="about-contact">
                ...
                <div className="contact-details">
                    ...
                    <div>
                        ...
                        <span>Email: consumersupport@jutachappal.com</span>
                    </div>
                </div>
            </section>
        </main>
